report 60000 "Shivam Mistry Sales Quote"
{
    Caption = 'Shivam Mistry Sales Quote';
    DefaultLayout = Word;
    PreviewMode = PrintLayout;
    WordLayout = 'src\Layout\Shivam Mistry Sales Quote Example.docx';
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                UseTemporary = true;
                column(LineNo_Line; "Sequence No. PCXP")
                {
                }
